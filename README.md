...
| 测试 | 1084 passed，0 failed / 0 error / 0 skipped；覆盖率 99.81% 行、99.75% 分支 |
...
| `tests` | 66 个测试文件，见 [`docs/TESTING.md`](docs/TESTING.md) |
...
**当前基线（快照 2026-09-16，TASK-090 重测）**：1084 passed，0 failed / 0 error / 0 skipped；
覆盖率 2685 语句 / 5 未覆盖 / 406 分支 → 99.81% 行、99.75% 分支。
