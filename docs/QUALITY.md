...
pytest -q                                  # 1035 passed
pytest -q --cov --cov-report=term-missing   # 1035 passed，并输出下表
ruff check .                               # All checks passed!
```

> **当前基线（快照 2026-09-16）**：1035 passed / 63 个测试文件 / 941 个 `def test_*` /
...
- **1035 个用例全部通过**，0 failed / 0 error / 0 skipped（63 个测试文件，941 个
