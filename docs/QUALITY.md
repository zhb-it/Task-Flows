...
pytest -q                                  # 1037 passed
pytest -q --cov --cov-report=term-missing   # 1037 passed，并输出下表
ruff check .                               # All checks passed!
```

> **当前基线（快照 2026-09-16）**：1037 passed / 63 个测试文件 / 943 个 `def test_*` /
...
- **1037 个用例全部通过**，0 failed / 0 error / 0 skipped（63 个测试文件，943 个
